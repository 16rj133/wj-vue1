  ...
  <div class="paper_title">
   ...
   <BarSchart></BarSchart>
      ...
      <div class="score_text">
        ...
        <div>
          <el-progress type="circle" :percentage="percentage"><span>{{myScore}}</span>分</el-progress>
        </div>
...
<script>
  ...
  import BarrSchart from '../../components/Schart/BarrSchart.vue'
