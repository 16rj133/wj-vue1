      ...
      <el-header style="margin:30px; padding: 0px;display:flex;justify-content:space-between;align-items: center">
        <div style="display: inline">
          ...
          <el-row style="margin-top: 20px">
            <span>班级：</span>
            <el-select v-model="classesNo" size="mini" clearable placeholder="请选择" style="width: 150px">
              <el-option
          ...
          <el-row>
              <div>
                <el-form-item label="学号:" prop="id">
                  <el-input prefix-icon="el-icon-edit" v-model="student.id" size="mini" style="width: 150px"
          ...
          <el-row>
            <div>
              <el-form-item label="年龄:" prop="age">
                <el-input prefix-icon="el-icon-edit" v-model="student.age" size="mini" style="width: 150px"
          ...
          <el-row>
            <div>
              <el-form-item label="电话:" prop="phone">
                <el-input prefix-icon="el-icon-edit" v-model="student.phone" size="mini" style="width: 150px"
          ...
          <el-row>
            <div>
              <el-form-item label="邮件:" prop="email">
                <el-input prefix-icon="el-icon-edit" v-model="student.email" size="mini" style="width: 150px"
  ...
  export default {
    data() {
      return {
        ...
        classesNo:'',
        dialogTitle: '',
        classesList: this.$store.state.classes,
        totalCount: -1,
        currentPage: 0,
        dialogVisible: false,
        resetPassword: false,
        ...
        rules: {
          ...
          id: [{required: true, message: '必填:学号', trigger: 'blur'}],
    ...
    methods: {
      deleteStudent(row){
        this.$confirm('此操作将永久删除[' + row.name + '], 是否继续?', '提示', {
          ...
          ///
          var _this = this;
          this.$axios.post("/student/delete/" + row.id, null).
        ...
        _this.loadStudents();
          ...
          //alert(444);//之前报错的原因是我没有在返回数据的函数前加上@responsebody注释
        })
      },
      keywordsChange(val){
        if (val === '') {
      ...
      loadStudents(){
        ...
        _this.students.forEach((e)=>{
          ...
          if (e.classesNo === _this.classesList[i].cid) {
            e.classesName = _this.classesList[i].cname
          }
        }
      });
          ...
          if (valid) {
            if (this.student.id) {
              if (this.resetPassword === true) {
                this.student.password = this.student.id
              }
              //更新
