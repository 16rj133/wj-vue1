  ...
  <div>
    <el-container class="home-container">
      <el-header class="home-header">
        <span class="home_title">作业管理平台</span>
        ...
        <el-container>
          <el-main>
            <el-breadcrumb separator-class="el-icon-arrow-right">
              <el-breadcrumb-item>作业管理平台</el-breadcrumb-item>
